...
tipo_de_cliente = input("Ingrese el tipo su tipo de cliente (Residencial, Comercial, Industrial): ").lower()
...
print(f"El subtotal del consumo es de ${subtotal}")
print(f"La bonificación del servicio es de ${bonificacion_a_cobrar}")
print(f"El recargo del servicio es de ${recargo_a_cobrar}")
print(f"El subtotal con recargo y bonificaciones es de ${subtotal_con_recargo_y_bonificaciones}")
print(f"El iva a agregar al subtotal es de ${IVA_a_cobrar}")
print(f"El total final a pagar es de ${total_final}")